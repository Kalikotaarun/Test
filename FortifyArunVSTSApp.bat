...
REM Created on 2019/07/27 21:40:20
REM ###########################################################################
...
set FPR="FortifyArunVSTSApp.fpr"
set BUILDID="ArunVSTSApp"
set ARGFILE="FortifyArunVSTSApp.bat.args"
set BYTECODE_ARGFILE="FortifyArunVSTSApp.bat.bytecode.args"
set MEMORY=-Xmx7235M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set OLDFILENUMBER=FortifyArunVSTSApp.bat.fileno
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="C:\Users\akalikota\Documents\Visual Studio 2015\Projects\ArunVSTSApp"
...
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID%  MSBuild "C:\Users\akalikota\Documents\Visual Studio 2015\Projects\ArunVSTSApp\ArunVSTSApp.sln" /p:Configuration="Debug" /p:Platform="Any CPU" /target:"rebuild"
IF %ERRORLEVEL% NEQ 0  (
echo Sourceanalyzer failed, exiting
GOTO :FINISHED
)
